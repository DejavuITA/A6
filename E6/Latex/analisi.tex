...
Per quanto riguarda i dati ricavati con i giri più alti della valvola  aspillo (6, 7 e 8) il regime diventa viscoso ed essendo nelle condizioni di flusso viscoso laminare, descritte dal numero di Reynolds, abbiamo potuto calcolare la conduttanza teorica. I valori ricavati empiricamente sono risultati compatibili con quelli ricavati teoricamente. % ad eccetto del valore del tubo 8000x2.5 a 8 giri, il quale è fuori con un poggiuolo. :D
