...
caso in cui il sistema fosse in regime viscoso. % sorry for the mess
...
La seguente tabella ci permette di discriminare, usando il numero di Reynolds, i vari regimi di flusso viscoso:
