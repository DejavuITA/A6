...
\begin{itemize}
    ...
    dotato di valvola che collegava la pompa rotativa direttamente con la camera. In questo modo è stato possibile portare la camera a pressione atmosferica senza spegnere la pompa turbomolecolare, che necessita di un tempo abbastanza lungo (circa 10 minuti) per fermarsi.} %non mi piace ancora come è scritta...
