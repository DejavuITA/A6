...
Per completare il quadro teorico è doveroso chiarire cosa si intenda con $\theta\ped{max}$: questo angolo è l'angolo massimo di uscita, dal prisma, del ragio monocromatico. Infatti sperimentalmente si è osservato che sopra un certo $\theta$ il raggio luminoso non continua ad aumetare l'angolo che forma con il prolungamento del raggio incidente, ma ''ritorna indietro''.\\
