...
\begin{itemize}
        ...
        \item{\SI{100}{\milli\liter} di soluzione di \ce{CH3COOH} a concentrazione incognita;}
...
\end{equation}
%
(gli ioni \ce{Na+} sono spettatori e sono stati omessi dalla formula per semplicità).

Questa reazione ha una costante di equilibrio $K\ped{eq} \simeq 10^9$ poichè l'acido acetico ha $K\ped{A} \simeq 10^{-5}$,
...
Si può sfruttare questo fatto nel seguente modo: si aggiunge \ce{NaOH} alla soluzione titolanda misurando allo
...
Mediante la buretta si è poi versato nel beker la soluzione 0.1 M (anche questa senza incertezza) di \ce{NaOH}, inizialmente a
