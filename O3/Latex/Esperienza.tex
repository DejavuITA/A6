...
%\begin{figure}[h]
%    \includegraphics[width=80mm]{grafico.pdf}
%	\label{In questa figura sono graficati in dati dell'intensità relativa ($I/I\ped{0}$) in funzione del seno dell'angolo ($sen\vartheta$)}
%\end{figure}
