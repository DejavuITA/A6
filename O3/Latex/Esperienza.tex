...
%\begin{figure}[b]
    %\includegraphics[width=150mm]{double_plot.pdf}
	%\caption{In questa figura sono graficati in dati dell'intensità relativa ($I/I\ped{0}$) in funzione del seno dell'angolo ($sen\vartheta$)}
%\end{figure}
